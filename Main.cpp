...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader("data/shaders/shad_basic_lighting.vs", "data/shaders/shad_basic_lighting.fs");
    ...
    // -----------------------------------------------------------------------------
    unsigned int diffuseMap = loadTexture("data/images/container2.png");
    unsigned int specularMap = loadTexture("data/images/container2_specular.png");
